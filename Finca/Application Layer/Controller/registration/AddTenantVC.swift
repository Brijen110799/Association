...
//  Finca
//
//  Created by Fincasys Macmini on 15/03/21.
...
class AddTenantVC: BaseVC {
    ...
    @IBOutlet weak var lbTenantDatials: UILabel!
    ...
    override func viewDidLoad() {
     ...
     //   lblCountryNameCode.text = "\u{1F1EE}\u{1F1F3} +91"
      setDefultCountry()
        ...
        lbTenantDatials.text = doGetValueLanguage(forKey: "tenant_details")
...
//
    ...
    func doCallApi(){
        ...
        print(convertImageTobase64(imageView: imgUserProfile))
        let params = ["addTenantOnly":"addTenantOnly",
...
extension AddTenantVC : UIDocumentPickerDelegate, UINavigationControllerDelegate,UIImagePickerControllerDelegate , OpalImagePickerControllerDelegate{
...
extension  AddTenantVC :   UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout ,OnClickDeleteImage {
...
extension AddTenantVC : CountryListDelegate {
