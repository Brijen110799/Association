...
protocol ACFloatingTextfieldDeleteActionDelegate {
    func textFieldDidSelectDeleteButton(_ textField: ACFloatingTextfield) -> Void
}
...
@objc open class ACFloatingTextfield: UITextField {
    ...
    var deleteDelegate: ACFloatingTextfieldDeleteActionDelegate?
