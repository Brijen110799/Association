    ...
    func doSubmit() {
        ...
        if isOnwer{
            params = ["key":apiKey(),
                      ...
                      "owner_name":doGetLocalDataUser().userFullName!,
            ...
            params = ["key":apiKey(),
                      "switchUser":"switchUser",
                      "society_id":doGetLocalDataUser().societyID,
                      "owner_name":doGetLocalDataUser().ownerName,
                      "owner_email":doGetLocalDataUser().ownerEmail,
                      "owner_mobile":doGetLocalDataUser().ownerMobile,
                      "addUser":"0",
                      "user_id":doGetLocalDataUser().userID!,
                      "unit_id":doGetLocalDataUser().unitID!]
        }
