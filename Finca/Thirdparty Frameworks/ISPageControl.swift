...
//  EyedentifyMe
//
//  Created by Silverwing Technologies on 02/04/21.
//  Copyright © 2021 smTech. All rights reserved.
//
...
open class ISPageControl: UIControl {
    ...
    @IBInspectable open var borderWidthPageControl: CGFloat = 0 {
        didSet {
            setNeedsLayout()
        }
    }
    
    @IBInspectable open var borderColorPageControl: UIColor = UIColor.clear {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    open override func layoutSubviews() {
        ...
        dotLayers.forEach {
            if borderWidth > 0 {
                $0.borderWidth = borderWidthPageControl
                $0.borderColor = borderColorPageControl.cgColor
            }
        }
