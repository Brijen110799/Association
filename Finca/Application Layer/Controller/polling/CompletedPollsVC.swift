            ...
            if json != nil {
                do {
                    ...
                    if response.status == "200" {
                        self.pollingQuesList = response.votingCompleted
...
extension CompletedPollsVC :  IndicatorInfoProvider{
...
extension CompletedPollsVC : UITableViewDelegate,UITableViewDataSource{
