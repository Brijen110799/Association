            ...
            if (isProfile) {
              ///  let data = ModelInfoMember(name: tfNAme.text!,number: tfAge.text!,relation: lbDropDown.text!,isEmergancy: isEmergancy)
                ...
                if isEmergancy {
                    ...
                    let data = Member(userID: "", userFirstName: "", userLastName: "", userMobile: "", memberDateOfBirth: "", memberAge: tfAge.text!, memberRelationName: lbDropDown.text!, userStatus: "", memberStatus: "")
